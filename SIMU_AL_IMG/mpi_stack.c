...
{    
    ...
    {
        // printf("loop 0 i_next %d n_iter_a_stack %d rank %d \n", i_next, n_iter_a_stack, my_rank);
        ...
        if (my_rank == root_rank)
        {
            ...
            // printf("loop 1 i_next %d n_iter_a_stack %d rank %d \n", i_next, n_iter_a_stack, my_rank);
            ...
            // printf("loop 2 i_next %d n_iter_a_stack %d rank %d \n", i_next, n_iter_a_stack, my_rank);
        ...
        {   
            ...
            // printf("loop 7 i_next %d n_iter_a_stack %d rank %d \n", i_next, n_iter_a_stack, my_rank);
            //
